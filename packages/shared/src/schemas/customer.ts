...
export const customerProfileSchema = z.object({
  ...
  travellerTypeMix: z.object({
    family: probabilitySchema,
    couple: probabilitySchema,
    solo: probabilitySchema,
    group: probabilitySchema,
  }),
  ...
  hotelCategory: z.object({
    "3": probabilitySchema,
    "4": probabilitySchema,
    "5": probabilitySchema,
    luxury: probabilitySchema,
  }),
...
export const travelHistorySchema = z
  .object({
    ...
    travellers: z.object({
      ...
      type: z.enum(["family", "couple", "solo", "group"]),
    }),

...
| `households/{householdId}` | Yes | Yes | Permissioned shared and per-traveller household preferences. |
| `preferenceSignals/{signalId}` | Yes | Yes | Immutable preference evidence with provenance and model-training permission. |
...
| `voiceSessions/{voiceSessionId}` | Yes | Yes | Consent-aware voice session state, transcript links and latency evidence. |
...
| `declaredPreferences` | object | No |
| `preferenceCompleteness` | number | No |
| `profile` | object | No |
| `segments` | object[] | Yes |
| `vector` | number[] | No |
...
| `id` | string | Yes |
| `orgId` | string | Yes |
| `type` | enquiry \| quoteViewed \| replied \| booked \| cancelled \| offerSent \| offerClicked \| chatMessage \| preferenceDeclared \| preferenceUpdated \| voiceSession \| campaignSent \| campaignOpen \| campaignDelivered \| campaignRead \| campaignReplied \| campaignConverted \| optOut \| payment | Yes |
| `payload` | object | Yes |
...
Permissioned shared and per-traveller household preferences.
...
| `id` | string | Yes |
| `orgId` | string | Yes |
| `primaryCustomerId` | string | Yes |
| `homeCity` | string | Yes |
| `travellers` | object[] | Yes |
| `sharedPreferences` | object | Yes |
| `permissions` | object | Yes |
| `completeness` | number | Yes |
| `lastConfirmedAt` | string | Yes |
| `createdAt` | string | Yes |
| `updatedAt` | string | Yes |
| `createdBy` | string | Yes |
| `updatedBy` | string | Yes |

## `preferenceSignals/{signalId}`
...
| `householdId` | string | No |
| `travellerClientId` | string | No |
| `path` | string | Yes |
| `value` | object | Yes |
| `origin` | explicit_form \| explicit_chat \| explicit_staff \| observed_booking \| observed_interaction \| inferred_model | Yes |
| `confidence` | number | Yes |
| `capturedAt` | string | Yes |
| `validFrom` | string | Yes |
| `supersedes` | string | No |
| `modelTrainingAllowed` | boolean | Yes |
| `createdAt` | string | Yes |
| `updatedAt` | string | Yes |
| `createdBy` | string | Yes |
| `updatedBy` | string | Yes |
...
| `leadId` | string | No |
| `channel` | whatsapp \| web \| email \| voice | Yes |
| `mode` | text \| voice \| multimodal | Yes |
...
| `from` | object | Yes |
| `body` | string | Yes |
| `inputMode` | text \| voice \| tap \| system | Yes |
...
| `conversationId` | string | Yes |
| `customerId` | string | No |
| `status` | connecting \| active \| handover \| ended \| failed | Yes |
| `language` | string | Yes |
| `recordingAllowed` | boolean | Yes |
| `recordingPath` | string | No |
| `startedAt` | string | Yes |
| `endedAt` | string | No |
| `transcriptMessageIds` | string[] | Yes |
| `latency` | object | Yes |
| `createdAt` | string | Yes |
| `updatedAt` | string | Yes |
| `createdBy` | string | Yes |
...
| `approvedBy` | string | No |
| `status` | draft \| scheduled \| sending \| completed \| paused \| cancelled | Yes |
| `message` | object | No |
| `audienceSnapshot` | object | No |
| `stats` | object | Yes |
| `createdAt` | string | Yes |
| `updatedAt` | string | Yes |
| `createdBy` | string | Yes |
